...
# Working agreement (how Claude Code works with the user)

> Related: [CLAUDE.md](../../CLAUDE.md) (always-on context and attribution rules),
> [documentation.md](documentation.md) (reachable references),
> [data.md](data.md) (data hygiene). Standing ground rules for every task.

The user proposes the science and decides what becomes history. Claude prepares and proposes; the
...
`Co-Authored-By:` line and never write a "Generated with Claude Code" line, in any commit message or
PR description. Do not add any AI tool or third party as author or co-author. This overrides any
default behaviour. The full rule is in [CLAUDE.md](../../CLAUDE.md); a `commit-msg` hook in
